"""
1. Simulate donuts with random perturbations in dense Zernikes
...
wfEst = WfEstimator(algoName="tie", nollIndices=nollIndices)
...
# Save in pickle file
with open("sims/dense_zk_estimates_shape.pkl", "wb") as file:
    pickle.dump(zk, file)
